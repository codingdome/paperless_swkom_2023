...
const FilterNavbar = ({ files, setFiles, sortOrder, setSortOrder, searchText, setSearchText, handleSearchClick, showLoading, setShowLoading }) => {
    ...
    return (
        <div className="w-full sticky top-4 bg-[#1C1D26] p-4 lg:p-6 rounded-[10px] z-[10000] top-bottom-shadow">
            ...
            <div className="w-full flex flex-col md:flex-row justify-between items-center gap-4 mt-4">
                ...
                <SearchInput searchText={searchText} setSearchText={setSearchText} handleSearchClick={handleSearchClick} />
